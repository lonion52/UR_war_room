...
with tab_status:
    ...
    for sym in ordered_symbols:
            ...
            st.markdown(f"""
                <div class="swiss-card">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 8px; margin-bottom: 12px; font-family: monospace; text-align: center;">
                        <div style="background-color: #e4dac6; border: 1px solid #1f1a14; padding: 8px;">
                            <span style="font-size: 11px; font-weight: bold; opacity: 0.7;">最高價 × 0.9</span><br>
                            <strong style="font-size: 14px; color: #1f1a14;">{p90:.2f}</strong><br>
                            <span style="font-size: 12px; font-weight: bold; color: {'#FF6B35' if s90 == '已到達' else '#1f1a14'};">{s90}</span>
                        </div>
                        <div style="background-color: #e4dac6; border: 1px solid #1f1a14; padding: 8px;">
                            <span style="font-size: 11px; font-weight: bold; opacity: 0.7;">最高價 × 0.8</span><br>
                            <strong style="font-size: 14px; color: #1f1a14;">{p80:.2f}</strong><br>
                            <span style="font-size: 12px; font-weight: bold; color: {'#FF6B35' if s80 == '已到達' else '#1f1a14'};">{s80}</span>
                        </div>
                        <div style="background-color: #e4dac6; border: 1px solid #1f1a14; padding: 8px;">
                            <span style="font-size: 11px; font-weight: bold; opacity: 0.7;">最高價 × 0.7</span><br>
                            <strong style="font-size: 14px; color: #1f1a14;">{p70:.2f}</strong><br>
                            <span style="font-size: 12px; font-weight: bold; color: {'#FF6B35' if s70 == '已到達' else '#1f1a14'};">{s70}</span>
                        </div>
                    </div>
        ...
        # --- B. 00631L 專屬戰術面板 (移至第二順位) ---
            ...
            inv_slots = inv_slots[:3] # 防呆，確保只有3格
            ...
            st.markdown(f"""
                <div class="swiss-card">
                    <div style="font-weight: bold; font-size: 14px; margin-bottom: 14px; color: #1f1a14; border-bottom: 1px solid #1f1a14; padding-bottom: 4px;">
                        00631L 戰術部署
                    </div>
                    
                    <div style="font-size: 11px; font-weight: bold; font-family: monospace; margin-bottom: 6px;">庫存狀態 (進度 {total_buys_631l}/3)</div>
                    <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 8px; margin-bottom: 20px; font-family: monospace;">
                        {inv_html}
                    </div>
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 8px; margin-bottom: 20px; font-family: monospace; text-align: center;">
                        <div style="background-color: #e4dac6; border: 1px solid #1f1a14; padding: 8px;">
                            <span style="font-size: 11px; font-weight: bold; opacity: 0.7;">高點 × 0.85</span><br>
                            <strong style="font-size: 14px; color: #1f1a14;">{L_85_price:.2f}</strong><br>
                            <span style="font-size: 11px; font-weight: bold; color: {'#FF6B35' if L_85 == '已到達' else '#1f1a14'};">{L_85}</span>
                        </div>
                        <div style="background-color: #e4dac6; border: 1px solid #1f1a14; padding: 8px;">
                            <span style="font-size: 11px; font-weight: bold; opacity: 0.7;">高點 × 0.80</span><br>
                            <strong style="font-size: 14px; color: #1f1a14;">{L_80_price:.2f}</strong><br>
                            <span style="font-size: 11px; font-weight: bold; color: {'#FF6B35' if L_80 == '已到達' else '#1f1a14'};">{L_80}</span>
                        </div>
                        <div style="background-color: #e4dac6; border: 1px solid #1f1a14; padding: 8px;">
                            <span style="font-size: 11px; font-weight: bold; opacity: 0.7;">高點 × 0.70</span><br>
                            <strong style="font-size: 14px; color: #1f1a14;">{L_70_price:.2f}</strong><br>
                            <span style="font-size: 11px; font-weight: bold; color: {'#FF6B35' if L_70 == '已到達' else '#1f1a14'};">{L_70}</span>
                        </div>
                    </div>
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 8px; margin-bottom: 8px; font-family: monospace; text-align: center;">
                        <div style="background-color: #e4dac6; border: 1px solid #1f1a14; padding: 8px;">
                            <span style="font-size: 11px; font-weight: bold; opacity: 0.7;">歷史高點 × 1.0</span><br>
                            <strong style="font-size: 14px; color: #1f1a14;">{R_10_price:.2f}</strong><br>
                            <span style="font-size: 11px; font-weight: bold; color: {'#FF6B35' if R_10 == '已到達' else '#1f1a14'};">{R_10}</span>
                        </div>
                        <div style="background-color: #e4dac6; border: 1px solid #1f1a14; padding: 8px;">
                            <span style="font-size: 11px; font-weight: bold; opacity: 0.7;">歷史高點 × 1.1</span><br>
                            <strong style="font-size: 14px; color: #1f1a14;">{R_11_price:.2f}</strong><br>
                            <span style="font-size: 11px; font-weight: bold; color: {'#FF6B35' if R_11 == '已到達' else '#1f1a14'};">{R_11}</span>
                        </div>
                        <div style="background-color: #e4dac6; border: 1px solid #1f1a14; padding: 8px;">
                            <span style="font-size: 11px; font-weight: bold; opacity: 0.7;">歷史高點 × 1.2</span><br>
                            <strong style="font-size: 14px; color: #1f1a14;">{R_12_price:.2f}</strong><br>
                            <span style="font-size: 11px; font-weight: bold; color: {'#FF6B35' if R_12 == '已到達' else '#1f1a14'};">{R_12}</span>
                        </div>
                    </div>
                </div>
            """, unsafe_allow_html=True)

        # --- C. 00981A 轉倉面板 (移至第三順位) ---
        elif sym == "00981A":
