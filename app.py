...
with tab_status:
    ...
    with col1:
        ...
        # 2. 00631L 戰術部屬 (1x3 庫存 + 1x2 標頭 + 3x4 網格)
        sym_631L = "00631L"
        ...
        for i in range(3):
            ...
            if "防禦" in val:
                slots_html += f'<div style="background-color: #FF6B35; color: #1f1a14; border: 1px solid #1f1a14; text-align: center; font-size: 11px; font-weight: bold; padding: 4px;">🛡️ 防禦</div>'
            elif "進攻" in val:
                slots_html += f'<div style="background-color: #FFD500; color: #1f1a14; border: 1px solid #1f1a14; text-align: center; font-size: 11px; font-weight: bold; padding: 4px;">⚔️ 進攻</div>'
            else:
